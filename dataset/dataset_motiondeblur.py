...
class DataLoaderTrain(Dataset):
    ...
    def __getitem__(self, index):
        ...
        #     noisy = TF.pad(noisy, (0, 0, 0, ps - H), fill=0)
        #     clean = TF.pad(clean, (0, 0, 0, ps - H), fill=0)
...
#####################################################################################################
class DataLoaderVal_rr(Dataset):
    def __init__(self, rgb_dir, img_options=None, rgb_dir2=None):
        super(DataLoaderVal_rr, self).__init__()
...
def get_validation_rr_data(rgb_dir, img_options=None):
    assert os.path.exists(rgb_dir)
    return DataLoaderVal_rr(rgb_dir, img_options, None)
