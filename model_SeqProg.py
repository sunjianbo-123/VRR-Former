...
class Uformer(nn.Module):
    def __init__(self, img_size=256, in_chans = 3, dd_in=3, patch_size = 4,
                 embed_dim=96, depths = [2, 2, 4, 8], depths_FFTblock=[2,2,2,2], num_heads = [2, 4, 6, 8],
        ...
        self.encoderlayer_0 = BasicUformerLayer(dim=embed_dim,
                                                ...
                                                input_resolution=(img_size // 4,
                                                                  img_size // 4),
                                                depth=depths[0],
                                                depth_spectblock=depths_FFTblock[0],
        ...
        self.encoderlayer_1 = BasicUformerLayer(dim=embed_dim * 2,
                                                ...
                                                input_resolution=(img_size // 8,
                                                                  img_size // 8),
                                                depth=depths[1],
                                                depth_spectblock=depths_FFTblock[1],
        ...
        self.encoderlayer_2 = BasicUformerLayer(dim=embed_dim * 4,
                                                ...
                                                input_resolution=(img_size // 16,
                                                                  img_size // 16),
                                                depth=depths[2],
                                                depth_spectblock=depths_FFTblock[2],
        ...
        self.conv = BasicUformerLayer(dim=embed_dim * 8,
                                      ...
                                      input_resolution=(img_size // 32,
                                                        img_size // 32),
                                      depth=depths[3],
                                      depth_spectblock=depths_FFTblock[3],
...
if __name__ == "__main__":
    ...
    depths = [2, 2, 2, 2]
    depths_FFT = [2, 2, 2, 2]
    model_restoration = Uformer(img_size=input_size, embed_dim=96, patch_size=4, depths=depths, depths_FFTblock=depths_FFT,
