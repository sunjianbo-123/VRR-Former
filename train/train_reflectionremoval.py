...
if opt.optimizer.lower() == 'adam':
    optimizer = optim.Adam(model_restoration.parameters(), lr=0.0002, betas=(0.9, 0.999), eps=1e-8,
                           weight_decay=0.02)
elif opt.optimizer.lower() == 'adamw':
    optimizer = optim.AdamW(model_restoration.parameters(), lr=0.0002, betas=(0.9, 0.999), eps=1e-8,
                            weight_decay=0.02)
else:
...
criterion_perceptual = PerceptualLossVGG19(resize=True,
                                           layer_weights=[1, 1 / 2.6, 1 / 3.7, 1 / 3.7, 1 / 2.6, 1]).cuda()
