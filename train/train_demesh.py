...
######### parser ###########
opt = options.Options().init(argparse.ArgumentParser(description='demesh')).parse_args()
print(opt)
import utils
...
from losses import CharbonnierLoss,SSIMLoss,PerceptualLossVGG19,EdgeLoss,EdgeLoss_MPRNet
...
######### Logs dir ###########
log_dir = os.path.join(opt.save_dir, 'demesh', opt.dataset, opt.arch + opt.env)
...
edge_weight = 0.05     # https://github.com/swz30/MPRNet
